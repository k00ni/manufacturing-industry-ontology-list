...
Das Modell basiert auf der Vorarbeit namens Integrated Manufacturing Planning Model (IMPM), welches von Dušan Šormaz und Kollegen entwickelt wurde.
Das SIMPM besteht aus einer Sammlung von OWL-Axiomen, welche unter Verwendung des Tools Protégé\footnote{\url{https://protege.stanford.edu/}} entwickelt wurden.
...
Die Ontologie wurde am 11.12.2021 in der Version 1 veröffentlicht und wird gegenwärtig von keinem weiteren Projekt referenziert. 
Eine dedizierte Projektseite konnte ebenfalls nicht ausfindig gemacht werden und der Verweis auf dem Industry-Portal ist zum aktuellen Zeitpunkt nicht gültig. 
