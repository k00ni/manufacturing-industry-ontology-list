...
\subsubsection{QUDT ontology, Quantities, Units, Dimensions and Types ontology}
...
\subsubsection{OM ontology}
OM wurde entwickelt als Teil einer umfassenderen Ontologie\cite{rijgersberg2013ontology}, der Ontology of Quantitative Research (OQR).
Diese Ontologie versucht umfassend die Grundlegenden Konzepte von Maßeinheiten und Konversion zu integrieren, die bei anderen 
Ontologien fehlen, wie z.B. die Konzepte Quantity und Prefix.
