...
Das Semantically Integrated Manufacturing Planning Model (SIMPM) ist eine Top-Level Ontologie, die grundlegenden Semantiken des Manufacturing-Process-Plannings erfasst.
Innerhalb dieser Ontologie werden die Planungsvariabeln Tools, Processes, Machines und Features innerhalb eines 3D-Raums mit den Dimensionen Time, Variety und Aggregation innerhalb des Manufacturing-Process-Plannings modelliert \cite{sormaz2019simpm}.
Die Ontologie basiert auf der Vorarbeit namens Integrated Manufacturing Planning Model (IMPM), welches von Dusan Sormaz und Kollegen entwickelt wurde.
Zur Entwicklung der Ontologie wurde das Tool Protégé\footnote{\url{https://protege.stanford.edu/}} verwendet.
Laut der zugehörigen Industry-Portal Seite \footnote{\url{https://industryportal.enit.fr/ontologies/SIMPM}} wurde sie von Arkopaul Sarkar und Dusan Sormaz entwickelt.
Die Ontologie wurde am 11.12.2021 in der Version 1.0 veröffentlicht\footnote{\url{\url{https://data.industryportal.enit.fr/ontologies/SIMPM/submissions/1/download?apikey=019adb70-1d64-41b7-8f6e-8f7e5eb54942}} und wird gegenwärtig von keinem weiteren Projekt referenziert.
Die ursprüngliche Projektseite \url{http://simpom.ohio.edu/mfg-planning#} ist nicht mehr erreichbar, weshalb die Projektseite auf Industry Portal aktuell der beste Anlaufpunkt für Interessenten ist.
Daher liegt die Vermutung nahe, dass dieses Projekt nicht mehr aktiv gepflegt wird.
