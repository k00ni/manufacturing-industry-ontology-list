...
Wir präsentieren die Ergebnisse einer Internet- und Literaturrecherche zur Ermittlung aller formalen und öffentlich zugänglichen Ontologien (und Vokabulare), die sich thematisch im Bereich Industrie einordnen lassen.
Öffentlich zugänglich heißt in diesem Fall, dass nur Ontologien von Interesse waren, für die ein Dokument in einer formalen Sprache (z.B. RDF/OWL) vorlag, welches über eine URL persistent abgerufen werden kann.
...
Zum Schluss kommt die \textbf{Task-Ontologie} (Synonyme: Application Ontology), welche auf konkrete Anwendungsfälle ausgerichtet ist und dafür notwendige Inhalte bereitstellt.
...
\section{Weitere Quellen für Ontologien}
...
In diesem Kapitel wird die verwendete Methodik vorgestellt.
Das Ziel war die Erarbeitung einer Liste mit Ontologien, die sich auf das Fachgebiet Industrie beziehen\footnote{Für weitere Informationen siehe vorheriges Kapitel zur thematischen Einordnung}.
...
TODO: Warum wurden diese gewählt? => dezidiert für Publikation solcher Ontologien da

\paragraph{https://data.ontocommons.linkeddata.es/index} TODO
...
- Es wurden auch Ontologien anhand ihrer Nutzung in OWL:Import Statements geprüft

- Manuelle Durchsicht der Liste https://basic-formal-ontology.org/users.html

- Github Suche (nur Einträge auf Englisch): https://github.com/search?q=topic%3Aontology+industry&type=repositories&ref=advsearch&p=1
  - Topic: ontology
  - Suchbegriffe: industry, manufacturing

\subsection{Aufnahme einer Ontologie}

Eine Ontologie wurde selektiert, wenn sie die folgenden Kriterien erfüllte.

\textbf{TODO: Auflistung in nummerierter Liste?}
...
In der Recherche sind Ontologien enthalten, welche auf Top-Level Ontologien aufbauen.
Diese Top-Level Ontologien sind von ihrer Natur her generalistisch ausgelegt und haben keinen expliziten Bezug zum Fachgebiet der Industrie.
Sie werden im Folgenden daher nur oberflächlich erwähnt, um dem Leser ein vollständiges Bild zu geben.
