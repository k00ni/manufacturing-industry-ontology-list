...
Die Supply-Chain-Reference-Ontology(IOF-SCRO) ist eine Domänenontologie, welche im Umfeld der Industry-Ontology-Foundation (IOF) entwickelt und gepflegt wird. Ihre Kompetenzen sind Standardisierung, Semantische Mediation, wie z.B. Datenkonversion und -integration, sowie automatisiertes Inferieren und Reasoning hinsichtlich der Lieferkettenverfolgung (Traceability Use-Case) und Lieferantenermittlung (Supplier-Discovery), welche die hauptsächlichen Andwendungsfälle dieser Ontologie sind\cite{Wallace2021} . Sie wurde von der Supply-Chain-Working-Group an der Texas-State-University unter der Leitung von Dr. Farhad Ameri\footnote{\url{https://oagi.org/pages/supply-chain-working-group}} entwickelt. Die Version 1 der Ontologie, wurde am 1. Januar 2023 veröffentlicht und letztmalig am 10. Oktober 2023 aktualisiert\footcite{\url{https://industryportal.enit.fr/ontologies/IOF-SCRO}}. Somit scheint das Projekt 
noch aktiv gepflegt zu werden. Die Supply-Chain-Reference-Ontology ist gekoppelt an die IoF-Core-Ontology\cite{Kulvatunyou2022} und als Mid-Level Ontologie einzuordnen. 
