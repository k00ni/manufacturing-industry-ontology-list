...
Der OntoCommons Ontology Catalogue kommt der angestrebten Liste von maschinenlesbaren RDF Ontologien am nächsten.
...
\textbf{Google Scholar}\footnote{\url{https://scholar.google.com/}} kam bei der Recherche in wissenschaftlichen Publikationen zum Einsatz.
Daneben gibt es viele weitere Anlaufstellen, die bei der Recherche eine Rolle spielten.
Nicht alle davon haben unmittelbar etwas mit Ontologien zu tun.
Die folgende Liste enthält alle Webseiten, die im Rahmen der Recherche genutzt wurden:
...
industry,defect,manufacturing,digital twin
